...
export default function Page() {
  return (
    <LegalPage
      ...
      description="Please read these enterprise privacy terms carefully before using the EARLY-N platform. These terms govern your access to and use of our enterprise infrastructure and services."
      sections={[...sections]}
    />
  );
}
